 ...
 */
public final class Customer_UI extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                dtm.setRowCount(0);
                String Sql2 = "select * from customer where status='1'";
                if (flag) {
                    Sql2 = "select * from customer where name like '%" + _q.getText() + "%' and status='1'";
                }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Title", "Description", "Adress", "Contact Number", "Added Date", "Added Time"
            }
        ) {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SAVE CUSTOMER", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 14), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        _print.setText("PRINT ALL CUSTOMER DETAILS");
    ...
    private void jMenuItem1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem1MousePressed
        if (evt.getButton() == 1) {
            ...
            if ("1".equals(ID)) {
                JOptionPane.showMessageDialog(this, "Can't Update Cash Customer Details !");
                clearValues();
            } else {
    ...
    private void jMenuItem2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem2MousePressed
        if (evt.getButton() == 1) {
            ID = jTable1.getValueAt(row, 0).toString();
            if ("1".equals(ID)) {
                JOptionPane.showMessageDialog(this, "Can't Delete Cash Customer Details !");
                clearValues();
            } else {
                try {
            ...
            if (ToDo) {
                ...
                if (isUpdate == 1) {
                    ...
                    if (IsOk) {
                        ...
                        JOptionPane.showMessageDialog(this, "Cant Update Date ! Please Try Again !");
                        clearValues();
                    }
