 ...
 * @author SCORFi3LD
 */
public class ItemNameSearchDialog_stock extends javax.swing.JDialog {
     ...
     */
    Stock_UI JF=null;
    public ItemNameSearchDialog_stock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        JF=(Stock_UI) parent;
        initComponents();
    ...
    private void loadItemNames(String text) {
        try {
            ResultSet rs = JDBC.getData("SELECT * FROM product WHERE title LIKE '%" + text + "%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemNameSearchDialog_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ItemNameSearchDialog_stock dialog = new ItemNameSearchDialog_stock(new javax.swing.JFrame(), true);
